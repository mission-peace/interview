...
public class CircularBinarySearch {
	...
	public int searchImproved(int arr[]) {
		int low = 0;
	...
	public static void main(String args[]) {
		...
		System.out.print(cbs.searchImproved(arr));

		int arr1[] = { 5, 8, 10, 7, 5, 3, 2 };
		System.out.print(cbs.searchImproved(arr1));

		int arr2[] = { 3, 5, 7, 10, 8, 5, 2 };
		System.out.print(cbs.searchImproved(arr2));

		int arr3[] = { 8, 5, 2, 3, 5, 7, 10 };
		System.out.print(cbs.searchImproved(arr3));

		int arr4[] = { 5, 3, 2, 5, 8, 10, 7 };
		System.out.print(cbs.searchImproved(arr4));

		int arr5[] = {100,20,10,5,2,8,11,16,19};
		System.out.print(cbs.searchImproved(arr5));

		int arr6[] = {200,2,10,15,20,80,110,160,190};
		System.out.print(cbs.searchImproved(arr6));

		int arr7[] = {5,10,20,50,200,800,1100,1600,1900,2};
		System.out.print(cbs.searchImproved(arr7));

		int arr8[] = {2,5,10,20,50,200,800,1100,1600,1900};
		System.out.print(cbs.searchImproved(arr8));
		
		int arr9[] = {3,1,8,5,4};
		System.out.print(cbs.searchImproved(arr9));
