...
struct node *MergeLLsRECUR(struct node *LL1,struct node *LL2)
{
	...
	{
		LL3 = LL1;
		LL3->next = MergeLLsRECUR(LL1->next,LL2);
	}
	else if(LL1->data > LL2->data)
	{
		LL3 = LL2;
		LL3->next = MergeLLsRECUR(LL1,LL2->next);
	}
	return LL3;
}
...
int main()
{
	...
	struct node *LL3 = MergeLLsRECUR(LL1,LL2);
